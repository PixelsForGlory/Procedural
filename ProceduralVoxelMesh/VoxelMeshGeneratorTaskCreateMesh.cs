                    ...
                    for(int j = 0; j < dimensionV; j++)
                    {
                        ...
                        while(i < dimensionU)
                        {
                            if(mask[n].HasFace)
                            {
                                ...
                                {
                                    case 1:
                                        UV0.Add(new Vector2(1.0f, 1.0f)); // 0
                                        UV0.Add(new Vector2(0.0f, 1.0f)); // 1
                                        UV0.Add(new Vector2(0.0f, 0.0f)); // 2
                                        UV0.Add(new Vector2(1.0f, 0.0f)); // 3
                                        break;
                                    case 2:
                                        UV0.Add(new Vector2(0.0f, 0.0f)); // 0
                                        UV0.Add(new Vector2(0.0f, 1.0f)); // 1
                                        UV0.Add(new Vector2(1.0f, 1.0f)); // 2
                                        UV0.Add(new Vector2(1.0f, 0.0f)); // 3
                                        break;
                                    case 3:
                                        UV0.Add(new Vector2(0.0f, 1.0f)); // 0
                                        UV0.Add(new Vector2(0.0f, 0.0f)); // 1
                                        UV0.Add(new Vector2(1.0f, 0.0f)); // 2
                                        UV0.Add(new Vector2(1.0f, 1.0f)); // 3
                                        break;
                                }
